...
<div x-data="{ open: false, payload: null }"
    ...
    <div @click="open = false" class="fixed inset-0 bg-gray-900/60 backdrop-blur-sm"></div>

    <!-- Card Content -->
    <div class="relative bg-white rounded-2xl max-w-sm w-full p-6 shadow-2xl border border-gray-100 space-y-4 text-center z-10">
