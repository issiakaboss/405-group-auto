<x-guest-layout>
    <div class="py-12 bg-gray-50/50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-gray-950 tracking-tight">My Favorites</h1>
                <p class="text-sm text-gray-500 mt-1">Saves and bookmarks of your dream vehicles.</p>
            </div>

            @if($favorites->isEmpty())
            <div class="bg-white border border-gray-100 rounded-2xl p-12 text-center shadow-sm max-w-xl mx-auto mt-12">
                ...
                <h3 class="text-base font-semibold text-gray-900">No favorites saved yet</h3>
                <p class="text-xs text-gray-400 mt-1 max-w-xs mx-auto">Explore our collection of exceptional cars and click the heart icon to save them here.</p>
                <div class="mt-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition flex flex-col group">
                    ...
                    <div class="relative aspect-[16/10] bg-gray-100 overflow-hidden">
                        @php
                        // Extraction de la première image HTTP du tableau casté
                        ...
                        <form action="{{ route('favorites.toggle', $vehicle) }}" method="POST" class="absolute top-3 right-3">
                            @csrf
                            <button type="submit" class="p-2 rounded-full bg-white/90 backdrop-blur-sm text-red-500 hover:bg-white shadow-sm transition">
                    ...
                    <div class="p-5 flex-1 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="flex items-center space-x-2 text-xs text-gray-400 font-medium mb-4">
                                ...
                                <span>•</span>
                                <span>{{ number_format($vehicle->mileage) }} miles</span>
                                <span>•</span>
