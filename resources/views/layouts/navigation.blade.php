            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" class="flex items-center space-x-2.5 group">
                        <x-application-logo class="block h-7 w-auto text-gray-900 transition" />
                        <span class="text-sm font-black tracking-tight text-gray-950 uppercase group-hover:text-gray-700 transition">
                            405 Group <span class="text-gray-500 font-medium">Auto</span>
                        </span>
                    </a>
                </div>
