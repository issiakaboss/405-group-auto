<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-5">
        ...
        <div>
            <label for="update_password_current_password" class="block text-xs font-semibold text-slate-300 mb-1.5">{{ __('Current Password') }}</label>
        ...
        <div>
            <label for="update_password_password" class="block text-xs font-semibold text-slate-300 mb-1.5">{{ __('New Password') }}</label>
        ...
        <div>
            <label for="update_password_password_confirmation" class="block text-xs font-semibold text-slate-300 mb-1.5">{{ __('Confirm Password') }}</label>
