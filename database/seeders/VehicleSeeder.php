...
class VehicleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Vehicle::create([
            ...
            'price' => 89950,
            'images' => [
                'https://images.unsplash.com/photo-1617814076367-b759c7d7e738?auto=format&fit=crop&w=800&q=80', // Face
                'https://images.unsplash.com/photo-1555215695-3004980ad54e?auto=format&fit=crop&w=800&q=80', // Profil
                'https://images.unsplash.com/photo-1607853202273-797f1c22a38e?auto=format&fit=crop&w=800&q=80', // Arrière
                'https://images.unsplash.com/photo-1542282088-fe8426682b8f?auto=format&fit=crop&w=800&q=80'  // Intérieur
            ],
        ...
        // 2. Mercedes-Benz S-Class (Featured)
        Vehicle::create([
            ...
            'status' => 'available_usa',
            'location' => 'USA (Transit requis)',
            'is_featured' => true,
        ]);

        // 3. Tesla Model S Plaid (Featured)
        Vehicle::create([
        ...
        // 5. Range Rover Autobiography (Latest)
        Vehicle::create([
