        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
            ...
            <div class="text-center max-w-3xl mx-auto space-y-4">
                ...
                <h1 class="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
                    Welcome to 405 Group Auto
                </h1>
                <p class="text-slate-600 text-sm sm:text-base leading-relaxed">
                    Your ultimate destination for luxury vehicles. We assist buyers in discovering premium inventory, requesting custom vehicle matches, and securing seamless transatlantic imports from the USA directly to Africa.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-5 space-y-6">
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-slate-100/50 p-6 sm:p-8 space-y-6">
                        <div>
                            <p class="text-xs font-bold uppercase tracking-widest text-amber-600 mb-1">Get in Touch</p>
                            <h2 class="text-2xl font-bold text-slate-900">About & Contact</h2>
                        </div>
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex items-start gap-3.5 p-3.5 rounded-xl bg-slate-50 border border-slate-100/80 hover:border-slate-200 transition">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-600 text-xs mt-0.5">1230 Auto Drive, Suite 400, Houston, TX 77002</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3.5 p-3.5 rounded-xl bg-slate-50 border border-slate-100/80 hover:border-slate-200 transition">
                                <div class="p-2.5 rounded-lg bg-white text-slate-900 shadow-sm shrink-0">
                                    <svg class="w-5 h-5 text-amber-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
                                </div>
                                <div>
                                    <p class="font-bold text-slate-900">Hours</p>
                                    <p class="text-slate-600 text-xs mt-0.5">Mon–Sat: 9:00 AM – 7:00 PM</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3.5 p-3.5 rounded-xl bg-slate-50 border border-slate-100/80 hover:border-slate-200 transition">
                                ...
                                <div>
                                    ...
                                    <p class="text-slate-600 text-xs mt-0.5">(555) 555-1234</p>
                                </div>
                            </div>
                ...
                <div class="lg:col-span-7">
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-slate-100/50 p-6 sm:p-8 space-y-6">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 mt-1">Fill out the form below and our team will get back to you within 24 hours.</p>
                        </div>
                        ...
                        <form action="{{ route('about.contact') }}" method="POST" class="space-y-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="name" placeholder="John Doe" required class="w-full rounded-xl border-slate-200 focus:border-slate-900 focus:ring-slate-900 text-sm placeholder:text-slate-300">
                                </div>
                                <div>
                                    <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1.5">Email Address</label>
                                    <input type="email" name="email" placeholder="john@example.com" required class="w-full rounded-xl border-slate-200 focus:border-slate-900 focus:ring-slate-900 text-sm placeholder:text-slate-300">
                                </div>
                            </div>

                            <div>
                                <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1.5">Phone Number</label>
                                <input type="text" name="phone" placeholder="+1 (555) 000-0000" required class="w-full rounded-xl border-slate-200 focus:border-slate-900 focus:ring-slate-900 text-sm placeholder:text-slate-300">
                            </div>

                            <div>
                                <label class="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-1.5">Message</label>
                                <textarea name="message" rows="5" placeholder="How can we help you acquire your next vehicle?" required class="w-full rounded-xl border-slate-200 focus:border-slate-900 focus:ring-slate-900 text-sm placeholder:text-slate-300"></textarea>
                            </div>
            ...
            <div class="pt-8 space-y-8">
                <div class="text-center max-w-xl mx-auto">
                    <h3 class="text-2xl font-bold text-slate-900">Why Choose 405 Group Auto?</h3>
                    <p class="text-slate-500 text-xs mt-1">We provide premium automotive experiences with unmatched service and quality</p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col items-center text-center group">
                        ...
                        <h4 class="font-bold text-slate-900 text-sm mb-1.5">Premium Quality</h4>
                        <p class="text-slate-500 text-xs leading-relaxed">Only the finest vehicles from trusted luxury brands worldwide.</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col items-center text-center group">
                        ...
                        <h4 class="font-bold text-slate-900 text-sm mb-1.5">Secured Logistics</h4>
                        <p class="text-slate-500 text-xs leading-relaxed">Full tracking from US ports straight to your local destination.</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col items-center text-center group">
                        ...
                        <h4 class="font-bold text-slate-900 text-sm mb-1.5">Expert Support</h4>
                        <p class="text-slate-500 text-xs leading-relaxed">24/7 dedicated support team covering two continents.</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition flex flex-col items-center text-center group">
                        ...
                        <h4 class="font-bold text-slate-900 text-sm mb-1.5">Transatlantic Deals</h4>
                        <p class="text-slate-500 text-xs leading-relaxed">Direct auction access in the USA with optimized localized pricing.</p>
                    </div>
                </div>
            </div>
