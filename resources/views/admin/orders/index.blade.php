    ...
    <div class="py-12 bg-slate-900 text-white min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h2 class="text-3xl font-extrabold text-white">Gestion des Commandes</h2>
                    <p class="text-slate-400 text-sm mt-1">Validez, mettez à jour ou annulez les commandes clients.</p>
                </div>
            </div>
